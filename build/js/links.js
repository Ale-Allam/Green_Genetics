const linksData = [
  {
    ...
    img: "image/links-pages/fruits-1.jpg",
  },
  {
    id: 2,
    category: "fruits",
    ...
    img: "image/links-pages/fruits-2.jpg",
  },
  {
    id: 3,
    category: "fruits",
    ...
    img: "image/links-pages/fruits-3.jpg",
  },
  {
    id: 4,
    category: "fruits",
  ...
  },
  {
    ...
    img: "image/links-pages/fruits-5.jpg",
  },
  {
    id: 6,
    category: "fruits",
  ...
  },
  {
    ...
    img: "image/links-pages/vegetables-2.jpg",
  },
  {
    id: 15,
    category: "vegetables",
  ...
  },
  {
    ...
    img: "image/links-pages/vegetables-5.jpg",
  },
  {
    id: 18,
    category: "vegetables",
    ...
    img: "image/links-pages/vegetables-6.jpg",
  },
  {
    id: 19,
    ...
    img: "image/links-pages/microgreens-1.jpg",
  },
  {
    id: 20,
    category: "microgreens",
  ...
  },
  {
    ...
    description:
      "If your big tree seems less thirsty than expected, delve into possible explanations with tree decorating aficionado Melissa Strauss. This article provides valuable insights to troubleshoot the issue.",
  ...
  },
  {
    ...
    category: "trees",
    title:
      "Rooting Tradition: Planting Your Live big Tree with Expert Tips",
    description:
      "Embarking on a journey with a live big tree? Gardening expert Melissa Strauss guides you through the process, ensuring your tree not only adorns your home but also becomes a lasting beauty in your garden.",
    img: "image/links-pages/trees-2.jpg",
  },
  {
    id: 24,
    category: "trees",
    title: "Hydration Harmony: Navigating big Tree Watering Essentials",
    description:
      "Amidst various suggestions for big tree water amendments, Melissa Strauss, a big tree enthusiast, clarifies the dos and don'ts. Ensure your tree receives the right hydration with these valuable insights.",
  ...
  },
  {
    ...
    img: "image/links-pages/flowers-2.jpg",
  },
  {
    id: 27,
    category: "flowers",
    ...
    img: "image/links-pages/flowers-3.jpg",
  },

  {
    id: 28,
    category: "housePlants",
    title: "Unveiling the Secrets: Reviving Your big Cactus Blooms",
    description:
      "big cactus plants are cherished for their vibrant winter flowers. If your big cactus missed its winter bloom, gardening expert Jill Drago explores four reasons behind the lack of blossoms.",
    img: "image/links-pages/housePlants-1.jpg",
  },
  {
    id: 29,
    category: "housePlants",
    ...
    img: "image/links-pages/housePlants-2.jpg",
  },
  {
    id: 30,
    category: "housePlants",
    title: "Leafy Mysteries: Why is My big Cactus Shedding Leaves?",
    description:
      "The sight of leaves dropping from your big cactus can be concerning. Known for their resilience, these plants usually thrive. Gardening expert Jill Drago identifies reasons behind leaf loss and offers solutions to restore your big cactus's health.",
    img: "image/links-pages/housePlants-3.jpg",
  },
  {
    id: 31,
    category: "housePlants",
    ...
    img: "image/links-pages/housePlants-4.jpg",
  },
  {
    id: 32,
...

  {
    ...
    img: "image/links-pages/raisedBedGardening-1.jpg",
  },
  {
    id: 42,
    category: "raisedBedGardening",
    ...
    img: "image/links-pages/raisedBedGardening-2.jpg",
  },
  {
    id: 43,
    category: "raisedBedGardening",
...
// section.id = window.location.hash.slice(1);
const getCateogry = document.querySelectorAll(".link a");
let linksHeader = document.querySelector(".h-header");
let linksMainH1 = document.querySelector(".links-main h1");
let linksMainP = document.querySelector(".links-main p");
let section = document.getElementById("links-data-container");

function createElement(img, title, description, category) {
  //spliting header words
  const inputString = category;
  const wordsArray = inputString
    .split(/(?=[A-Z])/)
    .join(" ")
    .toUpperCase();
  linksMainH1.innerText = wordsArray;
  // description
  linksMainP.innerText = description;

  const div = document.createElement("div");
  div.classList.add("card");
  const secDiv = document.createElement("div");
  secDiv.classList.add("description");

  const myH2 = document.createElement("h2");
  const myP = document.createElement("p");
  const reamMore = document.createElement("button");
  ...
  // Functions to toggle between sliced and full description
  function showFullDescription() {
    myP.textContent = fullDescription;
    reamMore.innerText = "Show Less";
    isFullDescription = true;
  }

  function showSlicedDescription() {
    myP.textContent = slicedDescription;
    reamMore.innerText = "Read More";
  ...
  reamMore.addEventListener("click", function () {
    if (isFullDescription) {
      showSlicedDescription();
      myP.style.background="none"
    } else {
      showFullDescription();
      myP.style.background="#f0f8ff"
    }
  });

  // Append elements to the div
  secDiv.append(myH2, myP);
  div.append(imgDiv, secDiv, reamMore);
...
function handleHashChange() {
  ...
  if (newHash) {
    const customData = newHash.slice(1); // Remove the '#' character
    section.innerHTML = "";
    linksData.forEach((el) => {
      const { img, title, description, category } = el;
      if (el.category === customData) {
        section.appendChild(createElement(img, title, description, category));
      }
    });
  } 
}
...
// linksData.filter(el => {
//   return el.category === section.id
// }).map( el => section.appendChild(createElement(el.img,el.title,el.description,el.category)))

// ========================sec try===============================

// getCateogry.forEach(e => {
//   e.addEventListener('hashchange', function () {
//     const customData = this.dataset.category;
//     section.innerHTML= "";
//     linksData.map(el => {
//       return el.category === customData ? section.appendChild(createElement(el.img,el.title,el.description,el.category)) : ''
//     })
